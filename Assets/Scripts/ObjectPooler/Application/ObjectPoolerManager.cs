...
namespace ObjectPooler.Application
{
    ...
    */
    public class ObjectPoolerManager : MonoBehaviour
    {
        ...
        private readonly List<List<ObjectPoolItem>> _allObjects = new List<List<ObjectPoolItem>>();
        ...
        private readonly Dictionary<string, ObjectPoolItem> _objectsPoolItems = new Dictionary<string, ObjectPoolItem>();

        //fast check if Pool is resizable, for example:
        //"building_Large" - true
        //"arrows" - false
        //this prevents for looping all the pools everytime
        private readonly Dictionary<string, bool> _autoResize = new Dictionary<string, bool>();
